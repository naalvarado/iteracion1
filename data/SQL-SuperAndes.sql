...
CREATE TABLE Perecederos(
  ...
  TIPO NUMBER,
  CONSTRAINT FK_ProductoPer FOREIGN KEY (ID) REFERENCES Productos(ID)
);
-- 16 NoPerecedero
CREATE TABLE NoPerecederos(
  ...
  TIPO NUMBER,
  CONSTRAINT FK_ProductoNP FOREIGN KEY (ID) REFERENCES Productos(ID)
);
-- 17 Abarrote
CREATE TABLE Abarrotes(
  ...
  PRECIO_UNITARIO NUMBER NOT NULL,
  TIPO NUMBER,
  CONSTRAINT FK_ProductoA FOREIGN KEY (ID) REFERENCES Productos(ID)
);
