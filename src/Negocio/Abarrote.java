...
public class Abarrote implements Producto{
	 ...
	 */
	public Abarrote(long iD,long pID,Integer pTipo,String nombre, String marca, double pPrecioUnidadMedida, double pPrecioUnitario, String pPresentacion, double pVolumen)
	{
		this.ID = iD;
		this.ubicacion = pID;
		this.nombre = nombre;
	 ...
	 * Constuctor basico 
	 */
	public Abarrote(long iD, String nombre)
	{
		this.ID = iD;
		this.nombre = nombre;
	}
